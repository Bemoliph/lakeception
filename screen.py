...
class Screen(object):
    def __init__(self, world, resX, resY):
        ...
        self.charmap = {}
        for char in CHARSET:
            self.charmap[char] = pygame.font.SysFont("monspace", font_size).render(char, False, gray)
        player = pygame.font.SysFont("monspace", font_size).render("@", False, player_color)
